...
/**
 * used for text messages, allows turns without turn mode restrictions.
 */
public class FollowImmediateEngine extends MovementEngine
{
	MovementEngine _target = null;
  
	protected FollowImmediateEngine(
			int direction,
